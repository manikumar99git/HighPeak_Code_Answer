...
public class highpeakcode {
	...
	public static void main(String[] args) throws Exception {
		...
		String locate1="C:\\Users\\PRITAM\\Desktop\\sample_input.txt";
		String locate2="C:\\Users\\PRITAM\\Desktop\\sample_output.txt";

		 FileReader file=new FileReader(locate1);
		 BufferedReader bf=new BufferedReader(file);
		 FileWriter output=new FileWriter(locate2,true);
